...
function showScreen(id) {
  ...
  // Retrigger transition tanpa mengubah display lewat inline style.
...
// Visibility sepenuhnya dikontrol oleh .screen dan .screen.active di CSS.
// Jangan memakai inline display/hidden karena bisa bertabrakan dengan CSS.
document.querySelectorAll('.screen').forEach(s => {
  s.classList.toggle('active', s.id === 'hero');
});
